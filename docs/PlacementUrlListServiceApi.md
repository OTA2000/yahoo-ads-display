# yahoo_ads_display.PlacementUrlListServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**placement_url_list_service_add_post**](PlacementUrlListServiceApi.md#placement_url_list_service_add_post) | **POST** /PlacementUrlListService/add |
[**placement_url_list_service_get_post**](PlacementUrlListServiceApi.md#placement_url_list_service_get_post) | **POST** /PlacementUrlListService/get |
[**placement_url_list_service_remove_post**](PlacementUrlListServiceApi.md#placement_url_list_service_remove_post) | **POST** /PlacementUrlListService/remove |
[**placement_url_list_service_set_post**](PlacementUrlListServiceApi.md#placement_url_list_service_set_post) | **POST** /PlacementUrlListService/set |


# **placement_url_list_service_add_post**
> PlacementUrlListServiceMutateResponse placement_url_list_service_add_post(placement_url_list_service_operation=placement_url_list_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.PlacementUrlListServiceApi(api_client)
    placement_url_list_service_operation = yahoo_ads_display.PlacementUrlListServiceOperation() # PlacementUrlListServiceOperation |  (optional)

    try:
        api_response = api_instance.placement_url_list_service_add_post(placement_url_list_service_operation=placement_url_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PlacementUrlListServiceApi->placement_url_list_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **placement_url_list_service_operation** | [**PlacementUrlListServiceOperation**](PlacementUrlListServiceOperation.md)|  | [optional]

### Return type

[**PlacementUrlListServiceMutateResponse**](PlacementUrlListServiceMutateResponse.md)
...
> PlacementUrlListServiceGetResponse placement_url_list_service_get_post(placement_url_list_service_selector=placement_url_list_service_selector)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.PlacementUrlListServiceApi(api_client)
    placement_url_list_service_selector = yahoo_ads_display.PlacementUrlListServiceSelector() # PlacementUrlListServiceSelector |  (optional)

    try:
        api_response = api_instance.placement_url_list_service_get_post(placement_url_list_service_selector=placement_url_list_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PlacementUrlListServiceApi->placement_url_list_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **placement_url_list_service_selector** | [**PlacementUrlListServiceSelector**](PlacementUrlListServiceSelector.md)|  | [optional]

### Return type

[**PlacementUrlListServiceGetResponse**](PlacementUrlListServiceGetResponse.md)
...
> PlacementUrlListServiceMutateResponse placement_url_list_service_remove_post(placement_url_list_service_operation=placement_url_list_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.placement_url_list_service_remove_post(placement_url_list_service_operation=placement_url_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PlacementUrlListServiceApi->placement_url_list_service_remove_post: %s\n" % e)
```
...
> PlacementUrlListServiceMutateResponse placement_url_list_service_set_post(placement_url_list_service_operation=placement_url_list_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.placement_url_list_service_set_post(placement_url_list_service_operation=placement_url_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PlacementUrlListServiceApi->placement_url_list_service_set_post: %s\n" % e)
```
