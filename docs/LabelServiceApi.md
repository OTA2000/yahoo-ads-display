# yahoo_ads_display.LabelServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.LabelServiceApi(api_client)
    label_service_operation = yahoo_ads_display.LabelServiceOperation() # LabelServiceOperation |  (optional)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.LabelServiceApi(api_client)
    label_service_selector = yahoo_ads_display.LabelServiceSelector() # LabelServiceSelector |  (optional)
