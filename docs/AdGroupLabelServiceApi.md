# yahoo_ads_display.AdGroupLabelServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.AdGroupLabelServiceApi(api_client)
    ad_group_label_service_operation = yahoo_ads_display.AdGroupLabelServiceOperation() # AdGroupLabelServiceOperation |  (optional)
