# yahoo_ads_display.CampaignServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.CampaignServiceApi(api_client)
    campaign_service_operation = yahoo_ads_display.CampaignServiceOperation() # CampaignServiceOperation |  (optional)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.CampaignServiceApi(api_client)
    campaign_service_selector = yahoo_ads_display.CampaignServiceSelector() # CampaignServiceSelector |  (optional)
