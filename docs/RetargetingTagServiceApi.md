# yahoo_ads_display.RetargetingTagServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**retargeting_tag_service_add_post**](RetargetingTagServiceApi.md#retargeting_tag_service_add_post) | **POST** /RetargetingTagService/add |
[**retargeting_tag_service_get_post**](RetargetingTagServiceApi.md#retargeting_tag_service_get_post) | **POST** /RetargetingTagService/get |


# **retargeting_tag_service_add_post**
> RetargetingTagServiceMutateResponse retargeting_tag_service_add_post(retargeting_tag_service_operation=retargeting_tag_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.RetargetingTagServiceApi(api_client)
    retargeting_tag_service_operation = yahoo_ads_display.RetargetingTagServiceOperation() # RetargetingTagServiceOperation |  (optional)

    try:
        api_response = api_instance.retargeting_tag_service_add_post(retargeting_tag_service_operation=retargeting_tag_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RetargetingTagServiceApi->retargeting_tag_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **retargeting_tag_service_operation** | [**RetargetingTagServiceOperation**](RetargetingTagServiceOperation.md)|  | [optional]

### Return type

[**RetargetingTagServiceMutateResponse**](RetargetingTagServiceMutateResponse.md)
...
> RetargetingTagServiceGetResponse retargeting_tag_service_get_post(retargeting_tag_service_selector=retargeting_tag_service_selector)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.RetargetingTagServiceApi(api_client)
    retargeting_tag_service_selector = yahoo_ads_display.RetargetingTagServiceSelector() # RetargetingTagServiceSelector |  (optional)

    try:
        api_response = api_instance.retargeting_tag_service_get_post(retargeting_tag_service_selector=retargeting_tag_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling RetargetingTagServiceApi->retargeting_tag_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **retargeting_tag_service_selector** | [**RetargetingTagServiceSelector**](RetargetingTagServiceSelector.md)|  | [optional]

### Return type

[**RetargetingTagServiceGetResponse**](RetargetingTagServiceGetResponse.md)
