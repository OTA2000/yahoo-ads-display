# yahoo_ads_display.AccountAdProductServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**account_ad_product_service_get_post**](AccountAdProductServiceApi.md#account_ad_product_service_get_post) | **POST** /AccountAdProductService/get |


# **account_ad_product_service_get_post**
> AccountAdProductServiceGetResponse account_ad_product_service_get_post(account_ad_product_service_selector=account_ad_product_service_selector)
...
------------- | ------------- | ------------- | -------------
 **account_ad_product_service_selector** | [**AccountAdProductServiceSelector**](AccountAdProductServiceSelector.md)|  | [optional]

### Return type

[**AccountAdProductServiceGetResponse**](AccountAdProductServiceGetResponse.md)
