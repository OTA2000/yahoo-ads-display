# yahoo_ads_display.CampaignLabelServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.CampaignLabelServiceApi(api_client)
    campaign_label_service_operation = yahoo_ads_display.CampaignLabelServiceOperation() # CampaignLabelServiceOperation |  (optional)
