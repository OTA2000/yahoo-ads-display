# yahoo_ads_display.FeedSetServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**feed_set_service_add_post**](FeedSetServiceApi.md#feed_set_service_add_post) | **POST** /FeedSetService/add |
[**feed_set_service_get_post**](FeedSetServiceApi.md#feed_set_service_get_post) | **POST** /FeedSetService/get |
[**feed_set_service_remove_post**](FeedSetServiceApi.md#feed_set_service_remove_post) | **POST** /FeedSetService/remove |


# **feed_set_service_add_post**
> FeedSetServiceMutateResponse feed_set_service_add_post(feed_set_service_operation=feed_set_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.FeedSetServiceApi(api_client)
    feed_set_service_operation = yahoo_ads_display.FeedSetServiceOperation() # FeedSetServiceOperation |  (optional)

    try:
        api_response = api_instance.feed_set_service_add_post(feed_set_service_operation=feed_set_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling FeedSetServiceApi->feed_set_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **feed_set_service_operation** | [**FeedSetServiceOperation**](FeedSetServiceOperation.md)|  | [optional]

### Return type

[**FeedSetServiceMutateResponse**](FeedSetServiceMutateResponse.md)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.FeedSetServiceApi(api_client)
    feed_set_service_selector = yahoo_ads_display.FeedSetServiceSelector() # FeedSetServiceSelector |  (optional)

    try:
        api_response = api_instance.feed_set_service_get_post(feed_set_service_selector=feed_set_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling FeedSetServiceApi->feed_set_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **feed_set_service_selector** | [**FeedSetServiceSelector**](FeedSetServiceSelector.md)|  | [optional]

### Return type

[**FeedSetServiceGetResponse**](FeedSetServiceGetResponse.md)
...
> FeedSetServiceMutateResponse feed_set_service_remove_post(feed_set_service_operation=feed_set_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.feed_set_service_remove_post(feed_set_service_operation=feed_set_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling FeedSetServiceApi->feed_set_service_remove_post: %s\n" % e)
```
