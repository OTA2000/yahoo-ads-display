# yahoo_ads_display.ConversionTrackerServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.ConversionTrackerServiceApi(api_client)
    conversion_tracker_service_operation = yahoo_ads_display.ConversionTrackerServiceOperation() # ConversionTrackerServiceOperation |  (optional)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.ConversionTrackerServiceApi(api_client)
    conversion_tracker_service_selector = yahoo_ads_display.ConversionTrackerServiceSelector() # ConversionTrackerServiceSelector |  (optional)
