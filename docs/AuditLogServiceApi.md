# yahoo_ads_display.AuditLogServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**audit_log_service_add_post**](AuditLogServiceApi.md#audit_log_service_add_post) | **POST** /AuditLogService/add |
...
> AuditLogServiceMutateResponse audit_log_service_add_post(audit_log_service_operation=audit_log_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.AuditLogServiceApi(api_client)
    audit_log_service_operation = yahoo_ads_display.AuditLogServiceOperation() # AuditLogServiceOperation |  (optional)

    try:
        api_response = api_instance.audit_log_service_add_post(audit_log_service_operation=audit_log_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AuditLogServiceApi->audit_log_service_add_post: %s\n" % e)
```
...
[**AuditLogServiceMutateResponse**](AuditLogServiceMutateResponse.md)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.AuditLogServiceApi(api_client)
    audit_log_service_download_selector = yahoo_ads_display.AuditLogServiceDownloadSelector() # AuditLogServiceDownloadSelector |  (optional)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.AuditLogServiceApi(api_client)
    audit_log_service_selector = yahoo_ads_display.AuditLogServiceSelector() # AuditLogServiceSelector |  (optional)
