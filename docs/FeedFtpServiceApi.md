# yahoo_ads_display.FeedFtpServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**feed_ftp_service_add_post**](FeedFtpServiceApi.md#feed_ftp_service_add_post) | **POST** /FeedFtpService/add |
[**feed_ftp_service_get_post**](FeedFtpServiceApi.md#feed_ftp_service_get_post) | **POST** /FeedFtpService/get |
[**feed_ftp_service_set_post**](FeedFtpServiceApi.md#feed_ftp_service_set_post) | **POST** /FeedFtpService/set |


# **feed_ftp_service_add_post**
> FeedFtpServiceMutateResponse feed_ftp_service_add_post(feed_ftp_service_operation=feed_ftp_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.FeedFtpServiceApi(api_client)
    feed_ftp_service_operation = yahoo_ads_display.FeedFtpServiceOperation() # FeedFtpServiceOperation |  (optional)

    try:
        api_response = api_instance.feed_ftp_service_add_post(feed_ftp_service_operation=feed_ftp_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling FeedFtpServiceApi->feed_ftp_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **feed_ftp_service_operation** | [**FeedFtpServiceOperation**](FeedFtpServiceOperation.md)|  | [optional]

### Return type

[**FeedFtpServiceMutateResponse**](FeedFtpServiceMutateResponse.md)
...
> FeedFtpServiceGetResponse feed_ftp_service_get_post(feed_ftp_service_selector=feed_ftp_service_selector)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.FeedFtpServiceApi(api_client)
    feed_ftp_service_selector = yahoo_ads_display.FeedFtpServiceSelector() # FeedFtpServiceSelector |  (optional)

    try:
        api_response = api_instance.feed_ftp_service_get_post(feed_ftp_service_selector=feed_ftp_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling FeedFtpServiceApi->feed_ftp_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **feed_ftp_service_selector** | [**FeedFtpServiceSelector**](FeedFtpServiceSelector.md)|  | [optional]

### Return type

[**FeedFtpServiceGetResponse**](FeedFtpServiceGetResponse.md)
...
> FeedFtpServiceMutateResponse feed_ftp_service_set_post(feed_ftp_service_operation=feed_ftp_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.feed_ftp_service_set_post(feed_ftp_service_operation=feed_ftp_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling FeedFtpServiceApi->feed_ftp_service_set_post: %s\n" % e)
```
