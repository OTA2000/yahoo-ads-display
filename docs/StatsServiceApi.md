# yahoo_ads_display.StatsServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**stats_service_get_post**](StatsServiceApi.md#stats_service_get_post) | **POST** /StatsService/get |


# **stats_service_get_post**
> StatsServiceGetResponse stats_service_get_post(stats_service_selector=stats_service_selector)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.StatsServiceApi(api_client)
    stats_service_selector = yahoo_ads_display.StatsServiceSelector() # StatsServiceSelector |  (optional)

    try:
        api_response = api_instance.stats_service_get_post(stats_service_selector=stats_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling StatsServiceApi->stats_service_get_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **stats_service_selector** | [**StatsServiceSelector**](StatsServiceSelector.md)|  | [optional]

### Return type

[**StatsServiceGetResponse**](StatsServiceGetResponse.md)
