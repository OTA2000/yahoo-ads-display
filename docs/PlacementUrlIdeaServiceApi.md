# yahoo_ads_display.PlacementUrlIdeaServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**placement_url_idea_service_get_post**](PlacementUrlIdeaServiceApi.md#placement_url_idea_service_get_post) | **POST** /PlacementUrlIdeaService/get |


# **placement_url_idea_service_get_post**
> PlacementUrlIdeaServiceGetResponse placement_url_idea_service_get_post(placement_url_idea_service_selector=placement_url_idea_service_selector)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.PlacementUrlIdeaServiceApi(api_client)
    placement_url_idea_service_selector = yahoo_ads_display.PlacementUrlIdeaServiceSelector() # PlacementUrlIdeaServiceSelector |  (optional)

    try:
        api_response = api_instance.placement_url_idea_service_get_post(placement_url_idea_service_selector=placement_url_idea_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PlacementUrlIdeaServiceApi->placement_url_idea_service_get_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **placement_url_idea_service_selector** | [**PlacementUrlIdeaServiceSelector**](PlacementUrlIdeaServiceSelector.md)|  | [optional]

### Return type

[**PlacementUrlIdeaServiceGetResponse**](PlacementUrlIdeaServiceGetResponse.md)
