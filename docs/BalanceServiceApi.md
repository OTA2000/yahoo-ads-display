# yahoo_ads_display.BalanceServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.BalanceServiceApi(api_client)
    balance_service_selector = yahoo_ads_display.BalanceServiceSelector() # BalanceServiceSelector |  (optional)
