# yahoo_ads_display.AdGroupAdLabelServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.AdGroupAdLabelServiceApi(api_client)
    ad_group_ad_label_service_operation = yahoo_ads_display.AdGroupAdLabelServiceOperation() # AdGroupAdLabelServiceOperation |  (optional)
