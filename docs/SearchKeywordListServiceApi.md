# yahoo_ads_display.SearchKeywordListServiceApi

All URIs are relative to *https://ads-display.yahooapis.jp/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**search_keyword_list_service_add_post**](SearchKeywordListServiceApi.md#search_keyword_list_service_add_post) | **POST** /SearchKeywordListService/add |
[**search_keyword_list_service_get_post**](SearchKeywordListServiceApi.md#search_keyword_list_service_get_post) | **POST** /SearchKeywordListService/get |
[**search_keyword_list_service_remove_post**](SearchKeywordListServiceApi.md#search_keyword_list_service_remove_post) | **POST** /SearchKeywordListService/remove |
[**search_keyword_list_service_set_post**](SearchKeywordListServiceApi.md#search_keyword_list_service_set_post) | **POST** /SearchKeywordListService/set |


# **search_keyword_list_service_add_post**
> SearchKeywordListServiceMutateResponse search_keyword_list_service_add_post(search_keyword_list_service_operation=search_keyword_list_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.SearchKeywordListServiceApi(api_client)
    search_keyword_list_service_operation = yahoo_ads_display.SearchKeywordListServiceOperation() # SearchKeywordListServiceOperation |  (optional)

    try:
        api_response = api_instance.search_keyword_list_service_add_post(search_keyword_list_service_operation=search_keyword_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SearchKeywordListServiceApi->search_keyword_list_service_add_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **search_keyword_list_service_operation** | [**SearchKeywordListServiceOperation**](SearchKeywordListServiceOperation.md)|  | [optional]

### Return type

[**SearchKeywordListServiceMutateResponse**](SearchKeywordListServiceMutateResponse.md)
...
# **search_keyword_list_service_get_post**
> SearchKeywordListServiceGetResponse search_keyword_list_service_get_post(search_keyword_list_service_selector=search_keyword_list_service_selector)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = yahoo_ads_display.SearchKeywordListServiceApi(api_client)
    search_keyword_list_service_selector = yahoo_ads_display.SearchKeywordListServiceSelector() # SearchKeywordListServiceSelector |  (optional)

    try:
        api_response = api_instance.search_keyword_list_service_get_post(search_keyword_list_service_selector=search_keyword_list_service_selector)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SearchKeywordListServiceApi->search_keyword_list_service_get_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **search_keyword_list_service_selector** | [**SearchKeywordListServiceSelector**](SearchKeywordListServiceSelector.md)|  | [optional]

### Return type

[**SearchKeywordListServiceGetResponse**](SearchKeywordListServiceGetResponse.md)
...
# **search_keyword_list_service_remove_post**
> SearchKeywordListServiceMutateResponse search_keyword_list_service_remove_post(search_keyword_list_service_operation=search_keyword_list_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.search_keyword_list_service_remove_post(search_keyword_list_service_operation=search_keyword_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SearchKeywordListServiceApi->search_keyword_list_service_remove_post: %s\n" % e)
```
...
# **search_keyword_list_service_set_post**
> SearchKeywordListServiceMutateResponse search_keyword_list_service_set_post(search_keyword_list_service_operation=search_keyword_list_service_operation)
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.search_keyword_list_service_set_post(search_keyword_list_service_operation=search_keyword_list_service_operation)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling SearchKeywordListServiceApi->search_keyword_list_service_set_post: %s\n" % e)
```
