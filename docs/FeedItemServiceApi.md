# yahoo_ads_display.FeedItemServiceApi
...
with yahoo_ads_display.ApiClient(configuration) as api_client:
    ...
    api_instance = yahoo_ads_display.FeedItemServiceApi(api_client)
    feed_item_service_operation = yahoo_ads_display.FeedItemServiceOperation() # FeedItemServiceOperation |  (optional)
